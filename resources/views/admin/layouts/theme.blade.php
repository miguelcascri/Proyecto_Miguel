...
{{-- <body class="app" style="background-color: white;"> --}}
    <body class="app" >
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="app-utilities col-auto">
                            <div class="app-utility-item app-notifications-dropdown dropdown">
                                {{-- <span class="logo-text h5"> {{ Auth::user()->name }}</span> --}}
                            ...
                            <div class="app-utility-item app-user-dropdown dropdown ">
                                <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
                                    ...
                                    {{-- <img
                                        src="{{ asset('assets/images/user.png') }}" alt="user profile"> --}}
                                    
                                        <i style="font-size: x-large" class="fa-solid fa-user"></i></a>
                                <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                                    ...
                                    <li><a class="dropdown-item itemMenu btn btn-warning"
        ...
        <div id="app-sidepanel" class="app-sidepanel">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <div class="app-branding">
                    {{-- <a class="app-logo" href="/home"><img class="logo-icon me-2" src="{{asset('assets/images/app-logo.svg')}}" --}}
                    {{-- <a class="app-logo" href="{{ asset('/home') }}"><img class="logo-icon me-2" --}}
                        <a class="app-logo" href="{{ route('adminhome') }}"><img class="logo-icon me-2"

                            src="{{ asset('assets/images/app-logo.svg') }}" alt="logo"><span class="logo-text">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            @if (Request::is('admin/adminreservas'))
                                <a class="nav-link active" href="{{ route('adminreservas') }}">
                                    <span class="nav-icon">
                            ...
                            @else
                                <a class="nav-link" href="{{ route('adminreservas') }}">
                                    <span class="nav-icon">
                                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list"
                                            fill="currentColor" xmlns="https://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            @if (Request::is('admin/adminclientes'))
                                <a class="nav-link active" href="{{ route('adminclientes') }}">
                                    <span class="nav-icon">
                                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                        {{-- <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-files"
                                        fill="currentColor" xmlns="https://www.w3.org/2000/svg"> --}}
                                        <img width="30em" height="30em" style="margin-left: -15%" viewBox="0 0 16 16"
                                            src="{{ asset('assets\img\client.png') }}">
                                        {{-- <path fill-rule="evenodd"
                            ...
                            @else
                                <a class="nav-link" href="{{ route('adminclientes') }}">
                                    <span class="nav-icon">
                                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                        {{-- <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-files"
                                        fill="currentColor" xmlns="https://www.w3.org/2000/svg"> --}}
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            @if (Request::is('admin/adminmesas'))
                                <a class="nav-link active" href="{{ route('adminmesas') }}">
                                    <span class="nav-icon">
                                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                        <img src="{{ asset('assets\images\iconmesa.png') }}" style="width: 12%;opacity: 88%;">
                                    </span>
                                    <span class="nav-link-text">Mesas</span>
                                </a>
                            @else
                                <a class="nav-link" href="{{ route('adminmesas') }}">
                                    <span class="nav-icon">
                                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                        {{-- <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-files"
                                            fill="currentColor" xmlns="https://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            @if (Request::is('admin/admincoments'))
                                <a class="nav-link active" href="{{ route('admincoments') }}">
                                    <span class="nav-icon">
                                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-files"
                                            fill="currentColor" xmlns="https://www.w3.org/2000/svg">
                            ...
                            @else
                                <a class="nav-link" href="{{ route('admincoments') }}">
                                    <span class="nav-icon">
                                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-files"
                                            fill="currentColor" xmlns="https://www.w3.org/2000/svg">
                        ...
                        <div class="app-sidepanel-footer" style="margin-bottom:-2%">
